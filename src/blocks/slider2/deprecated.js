...
// 13/1/2020 To fix narrator screen reader read first slider two time when infinity loop
const sliderSaveFixSliderScreenReaderAccessiblity = ({ attributes, setAttributes }) => {
	const {
		slides = [],
		autoSlide,
		autoplaySpeed,
...
const deprecated = [
	...
	{
		attributes: attributesFixDisplayNoneVideo,
		save: sliderSaveFixSliderScreenReaderAccessiblity,
	},
];
